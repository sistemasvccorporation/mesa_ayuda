    ...
    <div className="grid gap-6 lg:grid-cols-2">
      <div className="rounded-card border border-slate-200 bg-white p-4 sm:p-6">
        ...
        <button
          ...
          className="mt-4 w-full rounded-lg bg-brand-primary px-4 py-2.5 text-sm font-semibold text-white disabled:opacity-50 sm:w-auto"
        >
          Brindar permisos
        </button>
      </div>
      <div className="rounded-card border border-slate-200 bg-white p-4 sm:p-6">
        ...
        <ul className="mt-3 divide-y text-sm">
          {admins.map((r) => (
            <li key={r.id_usuario} className="flex flex-col gap-2 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
